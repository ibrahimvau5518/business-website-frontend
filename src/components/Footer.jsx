    ...
    <footer className="bg-slate-900 text-slate-300 py-16 font-sans border-t-4 border-brand">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Your trusted partner in premium industrial machinery components, reliable heavy-duty crane parts, and weather-resistant tarpaulin covers worldwide.
            </p>
            {/* Social Icons */}
            <div className="flex space-x-4 pt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-brand transition-colors duration-300">
          ...
          <div className="lg:pl-8">
            <h3 className="text-xl font-bold uppercase tracking-wider text-white mb-6 relative">
              <span className="relative z-10">Quick Links</span>
              <span className="absolute left-0 -bottom-2 w-10 h-1 bg-brand rounded-sm"></span>
            </h3>
            <ul className="space-y-3">
              {['Home', 'Services', 'Projects', 'Shop', 'About Us', 'Contact'].map((link) => (
                <li key={link}>
                  <Link to={`/${link.toLowerCase().replace(' ', '-')}`} className="text-slate-400 hover:text-brand transition-colors duration-200 flex items-center group">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li className="flex items-start">
                ...
                <span>123 Industrial Ave, Business Park<br />New York, NY 10012, USA</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-brand mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center">
                ...
                <span>support@craneparts.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} Crane Parts & Tarpaulin. All rights reserved.</p>
