      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-3xl md:text-4xl font-black text-heading uppercase tracking-tight mb-4">
              {product.name}
            </h1>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6 mb-8 space-y-6">
              <div>
              ...
              {isTarpaulin && tarpaulinBreakdown && tarpaulinBreakdown.area > 0 && (
                <div className="bg-slate-50 border border-slate-100 rounded-sm p-4 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between text-slate-600">
                    <span>Rate</span>
                    <span className="font-semibold text-heading">৳{tarpaulinBreakdown.rate.toFixed(2)}/sq ft</span>
                  </div>
